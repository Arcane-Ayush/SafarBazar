...
const views = {
    splash: () => `
        <div class="onboarding-screen" style="background: var(--primary); display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100dvh;">
    ...
    `,
    vendor_detail: () => `
        <div class="onboarding-screen" style="background: #F3F4F6; height: 100dvh; overflow-y: auto; position: relative;" id="vendor-detail-scroll" onscroll="handleVendorScroll()">
    ...
    my_requirements_list: () => `
        <div class="onboarding-screen" style="background: #FFFFFF; height: 100dvh; overflow-y: auto; position: relative;">
...
function openFilterSheet(filterType) {
    ...
    if (filterType === 'Location') {
        ...
        sheetBody.innerHTML = `
            <div style="display: flex; flex-direction: column; gap: 12px; max-height: 50dvh; overflow-y: auto; padding: 4px;">
                ${[
